...
CORE=../../Core
# Match the NDK build's Core config: internal API, debugger/cheat-search disabled,
# version string defined (Core/save_state.c hard-errors without GB_VERSION),
# multichar constants silenced (Core uses them intentionally; NDK build passes -Wno-multichar).
CFLAGS="-I. -I../../Core -I../.. -DGB_INTERNAL -DGB_DISABLE_DEBUGGER -DGB_VERSION=\"\\\"host-test\\\"\" -std=gnu11 -O2 -Wno-multichar"
